...
<a style="font-size: 200%;color: blue">未處理訂單</a>
<br>

<form method="post" action="ch_order.php">
<table border="1"  style="height:100%; width:100%;">
<br>    
    <td style="font-size: 120%;color: blue;text-align: center">手機號碼</td>
    <td style="font-size: 120%;color: blue;text-align: center">類別</td>
    ...
    <?php
        $result = $link -> query("SELECT * FROM `user_order` Where deal='no' order by `phone` ");
    ...
    /*?>
        ...
        <td>
            <label>
            <input type="checkbox" name="Check[]" value="<?php echo $rows[0] ?>">
            </label>
        </td>
        </tr>
    <?php  } ?>
    ...
    <button type="submit" name="ch1234">送出</button>
 </form>
