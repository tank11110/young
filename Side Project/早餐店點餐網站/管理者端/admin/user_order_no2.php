...
<br>    
    ...
    <?php
        ...
        while($rows=mysqli_fetch_array($result,MYSQLI_NUM))
        {
            ...
            {
    ?>
    <form method="post" action="ch_order.php?id=<?php echo $rows[0]; ?>">
            <?php
                if ($i==2||$i==4||$i==5||$i==7)
                {
                    if($i==2)
        ...
        <td>
            <?php
                ...
                {
            ?>
                    <input type="submit" name="ch_order" value="完成">
            <?php } ?>
        </td>
        </tr>
        </form>
...
<form action="user_order_no.php" method="post">
<?php
    if($hide)
    {
?>
    <input type="submit" value="調整完成"  name="update_done">   
<?php 
    } 
    else
    {
?>
    <input type="submit" value="調整訂單"  name="update">        
